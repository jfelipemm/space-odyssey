...
function Stage2:new()
	...
	background = Background(backgroundImgs[3])

	self.enemies = {}
	self.enemiesAmount = 30

	self.meteors = {}
	self.meteors1Amount = 45
...
function Stage2:updateObjects(dt)
